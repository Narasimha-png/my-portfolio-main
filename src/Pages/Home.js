    ...
    <Wrapper>
      <section className="card-section home-card">
        <div className="profile">
          ...
          <h1>
          Sri Lakshmi Narasimha Settipalli
          </h1>
          </div>
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#78cc6d"
              multiText={["Developer", "Competative Coder", "Student", "Learner"]}
              multiTextDelay={1000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            ...
            <a
              className="link"
              href="https://www.linkedin.com/in/slnarasimha/"
              rel="noreferrer"
              target="_blank"
              aria-label="linkedin"
            ...
            <a
              className="link"
              href="https://leetcode.com/Narasimha-png/"
              rel="noreferrer"
              target="_blank"
              aria-label="leetcode"
            ...
            <a
              className="link"
              href="https://www.instagram.com/narasimha_tiger_/?hl=en"
              rel="noreferrer"
              target="_blank"
              aria-label="whatsapp"
