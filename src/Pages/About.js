              ...
              <div className="col col-6 border-line-v">
                <div className="info-list"  data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Birthday: </strong>02 March 2004
                    </li>
                    <li>
                      <strong>Hometown: </strong>Balasanipalle, B.Kothakota, AndhraPradesh
                    </li>
                    <li>
                      <strong>Gmail: </strong>narasimhas9490@gmail.com
                    </li>
            ...
            <div className="row">
              <div className="col col-6 border-line-v">
                <div className="hobby-list">
                  <ul>
                    <li>
                      <strong>Reading Poetry</strong>
                    </li>
                    <li>
                      <strong>Competative Coding</strong>
                    </li>
                    <li>
